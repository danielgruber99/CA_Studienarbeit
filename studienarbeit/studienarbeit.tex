...
Im folgenden Beispiel wird ein ROP Angriff mit Berücksichtigung der Eigenschaften des STM32 dargestellt.
...
\"AAAA AAAA AAAA AAAA AAAA 0ROP\"  (Leerzeichen nicht als Eingabe, nur zur Lesbarkeit)
...
\begin{figure}[ht!]
  \begin{center}
    \includegraphics[scale=0.56]{figures/BufferOverflow.png}
...
%% TODO: konkreter machen?? ALSO MIT DEFINIERTE ARRAY GRÖße?
...
Für diesen Angriffstyp gibt es andere Schutzmaßnahmen wie die Nutzung von \ac*{aslr}, Stack Canaries und oder Watchdogs.
