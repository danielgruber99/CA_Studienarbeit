...
% TODO: decoy operations,randomisierung von startzugriffen bsp. zeigen
...
%%% TODO: 6. Compiler based Countermeasueres
...
% Für Besprechung der möglichen Skalierbarkeit automotive security (Einleitung und letztes Kapitel)
\bibitem{car format string vuln.} Automotive Security, \textit{Automotive Security}. n.d.. Zuletzt aufgerufen am: 25.06.2022. [Online]. \\https://www.bmwgroup-werke.com/de.html.https://cydrill.com/cyber-security/automotive-security-how-to-brick-your-car/
...
% OWASP Buffer Overflow Attack: https://owasp.org/www-community/vulnerabilities/Buffer_Overflow
% OWASP Format String Vuln.: https://owasp.org/www-community/attacks/Format_string_attack
...
% CA Quelle: https://courses.cs.washington.edu/courses/cse474/17wi/pdfs/lectures/03-arm_overview.pdf (ARM)
% CA Quelle: https://codearcana.com/posts/2013/05/02/introduction-to-format-string-exploits.html (FORMAT String)
